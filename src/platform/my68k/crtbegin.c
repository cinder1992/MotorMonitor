/* Basic x86_64-ELF ABI constructor runner */
...
func_ptr _init_array_start[0] __attribute__ ((used, section(".ctors"), aligned(sizeof(func_ptr)))) = { };
func_ptr _fini_array_start[0] __attribute__ ((used, section(".dtors"), aligned(sizeof(func_ptr)))) = { };
